...
def print_leaderboard():
    ...
    for player in leaderboard.players:
        ...
        counter += 1
        try:
            #returned_list.append((str(counter) + '.', player.rankedRating, player.gameName))
            s += str(counter) + '.' + ' ' + str(player.rankedRating) + ' ' + player.gameName + '\n'
            ...
            s += str(counter) + '.' + ' ' + str(player.rankedRating) + ' ' + 'Secret Agent' + '\n'
            #returned_list.append((str(counter) + '.', player.rankedRating, 'Secret Agent'))
